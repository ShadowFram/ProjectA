...
import net.mcreator.projecta.procedures.XPShowProcedure;
import net.mcreator.projecta.procedures.PlayerShowProcProcedure;
import net.mcreator.projecta.procedures.PlayerNameShowProcedure;
import net.mcreator.projecta.procedures.LevelShowProcedure;
...
public class PlayerInfoScreen extends AbstractContainerScreen<PlayerInfoMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		if (PlayerShowProcProcedure.execute(world, x, y, z) instanceof LivingEntity livingEntity) {
			InventoryScreen.renderEntityInInventoryFollowsAngle(guiGraphics, this.leftPos + -52, this.topPos + 3, 60, 0f, 0, livingEntity);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font,
				...
				LevelShowProcedure.execute(entity), 15, -89, -12829636, false);
		guiGraphics.drawString(this.font,
		...
		guiGraphics.drawString(this.font,
				...
				XPShowProcedure.execute(entity), -1, -79, -12829636, false);
	}
